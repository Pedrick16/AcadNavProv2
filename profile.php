...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Profile - Academic Navigator Pro</title>
...
<body style="background-color: #f8fafd;">
  ...
  <section>
    ...
    <div class="profile-box box-left "style=" box-shadow: 0 2px 4px rgba(0, 0, 0, .1), 0 8px 16px rgba(0, 0, 0, .1);   background-color: white;">
      ...
      <div class="options">
        <a class="btn btn-warning" href="editprofile.php">Edit Profile</a>
